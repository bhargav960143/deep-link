        ...
        <aside class="w-60 bg-white border-r border-gray-200 flex flex-col shrink-0">
            ...
            <nav class="flex-1 px-3 py-3 space-y-0.5">
                @php
                    $navItems = [
                        ...
                        ['route' => 'links.index', 'label' => 'Links',    'icon' => 'M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1'],
                        ['route' => 'guide',       'label' => 'Guide',    'icon' => 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253'],
            ...
            <div class="p-3 border-t border-gray-100">
                <div class="flex items-center gap-2 px-2 py-2">
                    <a href="{{ route('profile') }}" class="flex items-center gap-2 flex-1 min-w-0 hover:opacity-80 transition-opacity">
